...
join movie_info_idx AS mi_idx on (mi_idx.info > '6.5' AND t.id = mi_idx.movie_id AND mc.movie_id = mi_idx.movie_id AND mi_idx.movie_id = cc.movie_id ) 
...
join movie_info AS mi on (mi.info IN ('Sweden',   'Germany', 'Swedish', 'German') AND t.id = mi.movie_id AND mk.movie_id = mi.movie_id AND mi.movie_id = mi_idx.movie_id AND mi.movie_id = mc.movie_id AND mi.movie_id = cc.movie_id ) 
