...
join movie_info AS mi on (mi.info IN ('Germany',  'German', 'USA', 'American') AND t.id = mi.movie_id AND mk.movie_id = mi.movie_id AND mi.movie_id = mi_idx.movie_id AND mi.movie_id = mc.movie_id ) 
