...
join movie_info AS mi on (mi.note LIKE '%internet%' AND t.id = mi.movie_id AND mk.movie_id = mi.movie_id AND mi.movie_id = mc.movie_id AND mi.movie_id = att.movie_id ) 
