...
join cast_info AS ci on (ci.note IN ('(voice)', '(voice: Japanese version)', '(voice) (uncredited)', '(voice: English version)') AND t.id = ci.movie_id AND ci.movie_id = cc.movie_id ) 
